...
CSwitchWidget::CSwitchWidget(QWidget *parent): QWidget(parent)
{
    ...
    //渐进色
    m_onbkcolor1		= QColor(133, 133, 133);	//分开背景色1
    m_onbkcolor2		= QColor(99, 99, 99);		//分开背景色2

    //渐进色
    m_offbkcolor1		= QColor(91, 137, 14);		//闭合背景色1
    m_offbkcolor2		= QColor(71,103,8);			//闭合背景色2
    ...
    m_offname			= QString::fromLocal8Bit("开");
    m_onname			= QString::fromLocal8Bit("关");
